...
import { MiscellaneousDisplay } from "@/components/global/miscellaneous/miscellaneous-display";
...
export default function AboutPage() {
  ...
  const reasons = [
    {
      title: "Bridging Needs & Solutions",
      subtitle: "Delivering results and performance",
      description:
        "Our offer bridges your needs and our solution addresses your requirement, delivering results and performance you can trust.",
      image:
        "https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg", // e.g. professional business handshake or bridge motif
    },
    {
      title: "Aligned Market Positioning",
      subtitle: "Resonance in commitment",
      description:
        "Our market positioning matches your requirement, and our commitment resonates with you; we’re on the same wavelength.",
      image:
        "https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg", // e.g. matching puzzle pieces / compatibility
      reverse: true,
    },
    {
      title: "Clear Before vs After",
      subtitle: "Showcasing transformation",
      description:
        "Our competence enables a proposal that showcases ‘before vs after’ clarity to your concerns – you see what changed and why.",
      image: "https://images.pexels.com/photos/914931/pexels-photo-914931.jpeg", // e.g. comparison / contrasting visuals
    },
    {
      title: "Trust via Performance & Referrals",
      subtitle: "Built on credibility",
      description:
        "Our market performance and customer referrals build lasting trust with you — we don’t rely solely on claims.",
      image:
        "https://images.pexels.com/photos/3182789/pexels-photo-3182789.jpeg", // e.g. people or team together, reviews
      reverse: true,
    },
    {
      title: "Value Beyond Price",
      subtitle: "More than just cost",
      description:
        "Price is never the only factor — you may be pleasantly surprised by what we bring to the table beyond just numbers.",
      image:
        "https://images.pexels.com/photos/3183158/pexels-photo-3183158.jpeg", // e.g. gift or positive surprise visual
    },
  ];
  ...
  return (
    <div className="overflow-hidden">
      ...
      <motion.section
        ref={heroRef}
        className="relative h-screen flex items-center justify-center -mt-[64px] md:-mt-[80px] lg:-mt-[70px] xl:-mt-[74px] 2xl:-mt-[110px]"
        style={{
          y: y1,
          opacity: heroOpacity,
          scale: heroScale,
      ...
      >
        <div className="max-w-6xl mx-auto relative z-10 grid md:grid-cols-2 gap-12 md:gap-20 mb-12 items-center justify-center">
          {/* Vision */}
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.h2
              className="text-lg sm:text-3xl md:text-6xl font-bold font-sans text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 mb-4 sm:mb-6 leading-tight px-2"
              animate={{
          ...
          <div className="space-y-6 sm:space-y-8">
            {reasons.map((reason, index) => (
              <CardScrollAnimation key={index} reason={reason} index={index} />
            ))}
          </div>
        </div>
      </motion.section>

       <MiscellaneousDisplay priority={1} />
    </div>
  );
}
