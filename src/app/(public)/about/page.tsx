...
export default function AboutPage() {
  ...
  const y1 = useTransform(scrollYProgress, [0, 1], [0, -200 * parallaIntensity]);
  const y2 = useTransform(scrollYProgress, [0, 1], [0, -400 * parallaIntensity]);
  const y3 = useTransform(scrollYProgress, [0, 1], [0, -600 * parallaIntensity]);

  // Scroll-based rotation and scale - reduced for mobile
  const heroRotate = useTransform(scrollYProgress, [0, 0.2], [0, isMobile ? 2 : 5]);
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                  {stats.map((stat, index) => (
                    <motion.div
                      ...
                      whileHover={{ scale: isMobile ? 1.02 : 1.1, y: isMobile ? -5 : -20 }}
                      whileInView={{
            ...
            <Card className="bg-gradient-to-br from-green-100 to-emerald-100 border-green-200 shadow-xl">
              <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
                <div className="mb-4 sm:mb-6 flex flex-col items-center justify-center">
                  <motion.div
                    whileHover={{ scale: isMobile ? 1.02 : 1.1, rotateY: isMobile ? 180 : 360 }}
