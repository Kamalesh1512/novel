          ...
          >
            {navigationItems.map((item, index) => (
              <div
                ...
                style={{ position: "relative" }}
              >
                <button className="flex items-center px-4 py-3 text-white hover:text-black hover:bg-white/10 font-medium text-sm whitespace-nowrap transition-all duration-200 rounded-lg">
                  {item.title}
                  {item.hasDropdown && (
                    <ChevronDown
