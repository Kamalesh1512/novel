...
//     { src: "/Images/products/72_s_lid-removebg-preview.png", alt: "Product 3" },
//     { src: "/Images/products/Goat_Milk_Wipes.png", alt: "Product 4" },
//     { src: "/Images/products/72_s_lid-removebg-preview.png", alt: "Product 5" },
//     { src: "/Images/products/Goat_Milk_Wipes.png", alt: "Product 6" },
//   ];
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Overlay (visual only, no block) */}
        <div className="absolute inset-0 bg-black/10 z-10 pointer-events-none"></div>

        {/* Footer content */}
        <div
          className={`container mx-auto px-6 py-12 relative z-20 transition-all duration-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          {/* Main Footer Content */}
          ...
          {/* Bottom Section */}
          <div className="border-t pt-8 mt-12 bg-black/50 backdrop-blur-sm rounded-lg p-6 shadow-xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <p className="text-sm text-gray-400 text-center md:text-left relative z-40">
                COPYRIGHT © 2025 Novel Tissues. ALL RIGHTS RESERVED.
              </p>
